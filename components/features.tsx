...
<svg class="w-10 mb-5" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
  <rect class="stroke-current text-gray-300" stroke-width="1" x="6" y="16" width="8" height="52" rx="1" />
  <rect class="stroke-current text-gray-300" stroke-width="1" x="22" y="8" width="8" height="60" rx="1" />
  <rect class="stroke-current text-gray-300" stroke-width="1" x="38" y="24" width="8" height="44" rx="1" />
  <rect class="stroke-current text-gray-300" stroke-width="1" x="54" y="32" width="8" height="36" rx="1" />
</svg>
